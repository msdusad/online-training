            ...
            <div class="x_panel tile">
              <div class="x_title">
                <div class="row">
                  ...
                  <div class="col-lg-7 padding-top-10"> <a href="<?php echo WEB_ROOT;?>assets/index.php" class="h4"></a> </div>
                  <div class="col-lg-5 text-right MrTpMd-10"> <a href="<?php echo WEB_ROOT;?>assets/index.php" ></a>
              ...
              <div class="x_content">
                <h1 class="h3 padding-bottom-10"><b>Add Vendor</b></h1>
               <div class="row">
                ...
                <h1 class="h4 padding-bottom-10">Products</h1>
				  <!-- start table -->
					...
					<div class="content">
					 ...
					 <p>No Vendors associatedAdd Vendor</p>
					</div>
...
<div class="footer1">
<p class="text-center">No assets found Add Asset</p>
</div>
</div>
              </div>
            </div>
